...
namespace
{
	...
	StandardMesh GetTestMesh()
	{
		...
		const StandardVertex v1 = StandardVertex({ Math::Vector3(-1.0f, -1.0f, -1.0f), Math::Vector4(), Math::Vector3(), Math::Vector4(1, 1, 1, 1), Math::Vector2() });
...
namespace BoulderLeaf::Graphics
{
	...
	TEST(Mesh, Copy)
	{
		...
		mesh.GetVertexMutable(2) = StandardVertex({ Math::Vector3(-5.0f, -3.0f, -8.0f), Math::Vector4::Vector3D(8, 8, 8), Math::Vector3(), Math::Vector4(8, 1, 1, 1), Math::Vector2(6, 6) });
